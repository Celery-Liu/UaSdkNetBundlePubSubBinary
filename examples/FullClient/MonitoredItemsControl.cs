...
namespace UnifiedAutomation.Sample
{
    public partial class MonitoredItemsControl : UserControl
    {
        ...
        public void addMonitoredItem(NodeId nodeId)
        {
            try
            {
                ...
                catch (Exception exception)
                {
                    ...
                    // Update status label.
                    OnUpdateStatusLabel("An exception occurred while adding an item: " +
            ...
            {
                // Update status label.
                OnUpdateStatusLabel("An exception occurred while creating a subscription: " +
                        exception.Message, false);
            }
        }
        #endregion
        ...
        {
            // Retrieve the event data and create the according node id.
        ...
        private void MonitoringMenu_SamplingInterval_Click(object sender, EventArgs e)
        {
            ...
            {
                // Update status label.
                OnUpdateStatusLabel("An exception occurred while setting sampling interval: " + exception.Message, false);
            }
        }
        ...
        {
            // build a list of node ids for the WriteValueDialog
            ...
            {
                // Update status label.
                OnUpdateStatusLabel("An exception occurred while writing values: " +
                    exception.Message, false);
            }
        }
        ...
        private void MonitoringMenu_RemoveItems_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    // ToDo - maybe we want to check the status - but what to do if remove failed??
            ...
            {
                // Update status label.
                OnUpdateStatusLabel("An exception occurred while removing monitored items: " +
                    exception.Message, false);
            }
        }

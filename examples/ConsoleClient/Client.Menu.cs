    ...
    partial class Client
    {
        ...
        void PrintConnectedMenu()
        {
            lock (ConsoleLock)
            {
                ...
                Console.WriteLine(" - Press s to change the user                         -");
                Console.WriteLine(" - Press t to change the user password                -");
                Console.WriteLine(" - Press u to list the key credential configuration   -");
                Console.WriteLine(" - Press v to create a key credential                 -");
                Console.WriteLine(" - Press w to delete a key credential                 -");
            }
        }

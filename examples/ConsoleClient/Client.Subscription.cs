    ...
    partial class Client
    {
        ...
        void ProcessDataChange(object data, StatusCode error)
        {
            ...
            lock (ConsoleLock)
            {
                ...
                {
                    if (dataChange.MonitoredItem.UserData != null)
                    {
                        Console.Write(dataChange.MonitoredItem.UserData);
                    }
                    else
                    {
                        Console.Write(dataChange.MonitoredItem.NodeId);
                    }
        ...
        ClientState SubscribeForAlarm()
        {
            ...
            // Only subscribe to events that are actually alarms,
            // i.e., that are of type AlarmConditionType.
            monitoredItem.Filter.WhereClauses.Add(new ContentFilterElement
            {
                ...
                FilterOperands =
                {
                    ...
                    {
                        Value = new Variant(ObjectTypeIds.AlarmConditionType)
                    })
                }
            });

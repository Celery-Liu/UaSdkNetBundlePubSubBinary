...
namespace UnifiedAutomation.ClientGettingStarted
{
    ...
    /// </summary>
    public partial class ReadWithIndexRangeDlg : Form
    {
        /// <summary>
        ...
        public void Show(MainForm parent)
        {
            ...
            IndexRangeTB_TextChanged(this, null);
            Show();
        }
        #endregion
        ...
        private void IndexRangeTB_TextChanged(object sender, EventArgs e)
        {
            const string defaultText = "<first index>:<last index>";

            if (String.IsNullOrEmpty(IndexRangeTB.Text))
            {
                IndexRangeTB.Text = defaultText;
                IndexRangeTB.ForeColor = Color.Gray;
            }
            else if (IndexRangeTB.Text != defaultText)
            {
                if (IndexRangeTB.Text.Contains(defaultText))
                {
                    IndexRangeTB.Text = IndexRangeTB.Text.Replace(defaultText, String.Empty);
                }

                IndexRangeTB.ForeColor = Color.Empty;
            }
        }

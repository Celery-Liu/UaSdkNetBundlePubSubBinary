...
namespace UnifiedAutomation.ClientGettingStarted
{
    ...
    /// to a server.
    /// </summary>
    public partial class ReverseConnectDialog : Form
    {
        /// <summary>
        ...
        private void GetEndpoints()
        {
            try
            {
                ...
                using (Discovery discovery = new Discovery(m_parent.Application, ClientListeningUrl))
                {
                    endpoints = discovery.ReverseGetEndpoints(ServerUrlTB.Text);
                }
        ...
        {
            // create the object used to find servers or endpoints.
            Discovery discovery = new Discovery(m_parent.Application, ClientListeningUrl);
            ...
            try
            {
                ...
                discovery.BeginReverseGetEndpoints(
                    ServerUrlTB.Text,
        ...
        private void OnGetEndpointsCompleted(IAsyncResult result)
        {
            ...
            using (Discovery discovery = (Discovery)result.AsyncState)
            {
                ...
                {
                    // get the results.
                    List<EndpointDescription> endpoints = discovery.EndReverseGetEndpoints(result);
                    SetEndpoints(endpoints);
                }
        ...
        private void ReverseConnect()
        {
            try
            {
                ...
                // If you expect to connect to a (in-compliant) server that exposes its EndpointUrl
                // in an invalid way, following workaround could help.
                SelectedEndpoint.EndpointUrl = new Uri(SelectedEndpoint.EndpointUrl).ToString();
        ...
        public void ShowDialog(MainForm parent, string defaultUrl)
        {
            ...
            ClientListeningUrlTB.Text = defaultClientListeningURL;
            // get default values.
        ...
        private string defaultClientListeningURL = "opc.tcp://localhost:48070";
        #endregion

        #region Helpers for access to the gui
        private string ClientListeningUrl
        {
            get
            {
                return ClientListeningUrlTB.Text;
            }
        }

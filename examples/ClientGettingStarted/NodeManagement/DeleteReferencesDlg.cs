...
namespace UnifiedAutomation.ClientGettingStarted
{
    ...
    /// </summary>
    public partial class DeleteReferencesDlg : Form
    {
        /// <summary>
        ...
        private void DeleteReferences()
        {
            try
            {
                ...
                DeleteReferencesItem referenceToNode = new DeleteReferencesItem()
                {
                    ...
                    DeleteBidirectional = DeleteBidirectionalCK.Checked
                };

                List<DeleteReferencesItem> referencesToNode = new List<DeleteReferencesItem>();
                ...
                // add the reference.
                List<StatusCode> results = session.DeleteReferences(referencesToNode, null);
        ...
        /// </summary>
        private void BeginDeleteReferences()
        {
            try
            {
                // get the current session from the parent form.
                ...
                session.BeginDeleteReferences(referencesToNode, null, OnDeleteReferencesComplete, session);
            }
            catch (Exception exception)
            {
                ExceptionDlg.ShowInnerException(this.Text, exception);
        ...
        /// </summary>
        private void OnDeleteReferencesComplete(IAsyncResult ar)
        {
            // need to make sure the results are processed on the correct thread.
            if (InvokeRequired)
            {
                BeginInvoke(new AsyncCallback(OnDeleteReferencesComplete), ar);
                return;
            }
            ...
            {
                // add the reference.
                List<StatusCode> results = session.EndDeleteReferences(ar);
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteReferencesDlg"/> class.
        /// </summary>
        public DeleteReferencesDlg()
        {
            InitializeComponent();

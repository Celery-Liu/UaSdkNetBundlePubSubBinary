...
namespace UnifiedAutomation.ClientGettingStarted
{
    ...
    /// </summary>
    public partial class ModifyDataMonitoredItemsDlg : Form
    {
        /// <summary>
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyMonitoredItemsDlg"/> class.
        /// </summary>
        public ModifyDataMonitoredItemsDlg()
        {
            InitializeComponent();
        ...
        public bool ShowDialog(MainForm parent, Subscription subscription)
        {
            ...
            {
                if (monitoredItem is DataMonitoredItem)
                {
        ...
        private void UpdateItem(MonitoredItem monitoredItem)
        {
            DataMonitoredItem dataItem = monitoredItem as DataMonitoredItem;

            if (dataItem != null)
            {
                dataItem.SamplingInterval = (double)SamplingIntervalUD.Value;
                dataItem.QueueSize = (uint)QueueSizeUD.Value;
                dataItem.DiscardOldest = DiscardOldestCK.Checked;
                dataItem.DeadbandType = (DeadbandType)DeadbandTypeCB.SelectedItem;
                dataItem.Deadband = (double)DeadbandUD.Value;
            }
        }

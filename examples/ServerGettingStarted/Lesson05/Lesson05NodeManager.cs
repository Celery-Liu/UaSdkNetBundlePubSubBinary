...
{
    internal partial class Lesson05NodeManager : BaseNodeManager
    {
        /// <summary>
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting Lesson05NodeManager.");
            ...
            {
                Console.WriteLine("Failed to start Lesson05NodeManager. " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping Lesson05NodeManager.");
            ...
            {
                Console.WriteLine("Failed to stop Lesson05NodeManager. " + e.Message);
            }
        }
        ...
        /// </summary>
        public Lesson05NodeManager(ServerManager server) : base(server)
        {

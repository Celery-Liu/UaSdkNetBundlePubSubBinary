    ...
    internal partial class Lesson10NodeManager
    {
        ...
        private void UnderlyingSystem_BlockStateChanged(int blockAddress, string blockName, int state)
        {
            ...
            e.Initialize(
                ...
                FindInMemoryNode(new NodeId(blockName, InstanceNamespaceIndex)) as ObjectNode, // SourceNode
                this);
        ...
        private void SetAlarmCondition(BlockConfiguration block)
        {
            ...
            /// [Create RolePermission Alarm]
            var rolePermissions = new RolePermissionTypeCollection()
            {
                new RolePermissionType()
                {
                    RoleId = ObjectIds.WellKnownRole_Operator,
                    Permissions = PermissionTypeDataType.Browse | PermissionTypeDataType.Read | PermissionTypeDataType.ReadHistory | PermissionTypeDataType.ReceiveEvents | PermissionTypeDataType.Call
                },
                new RolePermissionType()
                {

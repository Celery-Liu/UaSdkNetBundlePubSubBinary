...
{
    internal partial class Lesson10NodeManager : BaseNodeManager
    {
        /// <summary>
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting Lesson10NodeManager.");
            ...
            {
                Console.WriteLine("Failed to start Lesson10NodeManager. " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping Lesson10NodeManager.");
            ...
            {
                Console.WriteLine("Failed to stop Lesson10NodeManager. " + e.Message);
            }
        }
        ...
        /// </summary>
        public Lesson10NodeManager(ServerManager server) : base(server)
        {

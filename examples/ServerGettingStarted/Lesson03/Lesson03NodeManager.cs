...
{
    internal class Lesson03NodeManager : BaseNodeManager
    {
        /// <summary>
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting Lesson03NodeManager.");

                base.Startup();

                // save the namespaces used by this node manager.
                TypeNamespaceIndex = AddNamespaceUri(yourorganisation.BA.Namespaces.BA);
                InstanceNamespaceIndex = AddNamespaceUri("http://yourcompany.com/lesson03/");
            ...
            {
                Console.WriteLine("Failed to start Lesson03NodeManager. " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping Lesson03NodeManager.");
            ...
            {
                Console.WriteLine("Failed to stop Lesson03NodeManager. " + e.Message); ;
            }
        }

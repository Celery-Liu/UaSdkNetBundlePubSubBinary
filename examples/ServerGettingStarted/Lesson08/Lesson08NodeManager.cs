...
{
    internal partial class Lesson08NodeManager : BaseNodeManager
    {
        /// <summary>
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting Lesson08NodeManager.");
                ...
                //HistoryReadEvent Step 1
                SetupEventHistory();
            }
            catch (Exception e)
            {
                Console.WriteLine("Failed to start Lesson08NodeManager. " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping Lesson08NodeManager.");
            ...
            {
                Console.WriteLine("Failed to stop Lesson08NodeManager. " + e.Message);
            }
        }
        ...
        /// </summary>
        public Lesson08NodeManager(ServerManager server) : base(server)
        {

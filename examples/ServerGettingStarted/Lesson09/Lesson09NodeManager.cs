...
{
    internal partial class Lesson09NodeManager : BaseNodeManager
    {
        /// <summary>
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting Lesson09NodeManager.");
            ...
            {
                Console.WriteLine("Failed to start Lesson09NodeManager. " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping Lesson09NodeManager.");
            ...
            {
                Console.WriteLine("Failed to stop Lesson09NodeManager. " + e.Message);
            }
        }
            ...
            IList<ReadValueId> settings)
        {
            for (int ii = 0; ii < operationHandles.Count; ii++)
            {
                ...
                if (address != null)
                {
                    /// [RolePermission Check Read access]
            ...
            IList<WriteValue> settings)
        {
            for (int ii = 0; ii < operationHandles.Count; ii++)
            {
                ...
                if (address != null)
                {
                    ...
                    /// [RolePermission Check Write access]
        ...
        /// </summary>
        public Lesson09NodeManager(ServerManager server) : base(server)
        {

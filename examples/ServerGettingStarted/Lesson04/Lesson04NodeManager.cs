...
{
    internal partial class Lesson04NodeManager : BaseNodeManager
    {
        /// <summary>
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting Lesson04NodeManager.");

                base.Startup();

                // save the namespaces used by this node manager.
                TypeNamespaceIndex = AddNamespaceUri(yourorganisation.BA.Namespaces.BA);
                InstanceNamespaceIndex = AddNamespaceUri("http://yourcompany.com/lesson04/");
            ...
            {
                Console.WriteLine("Failed to start Lesson04NodeManager. " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping Lesson04NodeManager.");
            ...
            {
                Console.WriteLine("Failed to stop Lesson04NodeManager. " + e.Message);
            }
        }
        ...
        /// </summary>
        public Lesson04NodeManager(ServerManager server) : base(server)
        {

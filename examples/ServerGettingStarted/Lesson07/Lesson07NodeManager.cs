...
{
    internal partial class Lesson07NodeManager : BaseNodeManager
    {
        /// <summary>
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting Lesson07NodeManager.");
            ...
            {
                Console.WriteLine("Failed to start Lesson07NodeManager. " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping Lesson07NodeManager.");
            ...
            {
                Console.WriteLine("Failed to stop Lesson07NodeManager. " + e.Message);
            }
        }
        ...
        /// </summary>
        public Lesson07NodeManager(ServerManager server) : base(server)
        {

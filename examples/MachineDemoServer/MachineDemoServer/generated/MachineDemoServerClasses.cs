...
namespace UnifiedAutomation.MachineDemoServer
{
    ...
    public partial class GlassTemperingMachineModel : GlassMachineModel, IMethodDispatcher
    {
        ...
        /// <summary>
        /// Gets or sets the GlassTemperingMachine async methods.
        /// </summary>
        /// <value>
        /// The GlassTemperingMachine async methods.
        /// </value>
        public IGlassTemperingMachineAsyncMethods GlassTemperingMachineAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IGlassTemperingMachineAsyncMethods implementation = GlassTemperingMachineAsyncMethods ?? this as IGlassTemperingMachineAsyncMethods;
            ...
            else if (methodDeclarationId == UnifiedAutomation.MachineDemoServer.MethodIds.GlassTemperingMachineType_Process)
            {
                ret = await implementation.ProcessAsync(context, this, context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == UnifiedAutomation.MachineDemoServer.MethodIds.GlassTemperingMachineType_Setup)
            {
                ret = await implementation.SetupAsync(context, this, context.CancellationToken).ConfigureAwait(false);
    ...
    /// <summary>
    /// The interface for async methods implemented on the GlassTemperingMachineModel object.
    /// </summary>
    public interface IGlassTemperingMachineAsyncMethods
    {
        /// <summary>
        /// Sets the MachineryItemState to Processing
        /// </summary>

...
namespace OpcUa.DI
{
    ...
    public partial class LockingServicesModel : BaseObjectModel, IMethodDispatcher
    {
        ...
        /// <summary>
        /// Operation result and output arguments for BreakLock.
        /// </summary>
        public struct BreakLockAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
            public StatusCode StatusCode;

            /// <summary>
            /// </summary>
            public int BreakLockStatus;
        }

        /// <summary>
        /// Operation result and output arguments for ExitLock.
        /// </summary>
        public struct ExitLockAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
            ...
            /// <summary>
            /// </summary>
            public int ExitLockStatus;
        }

        /// <summary>
        /// Operation result and output arguments for InitLock.
        /// </summary>
        public struct InitLockAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
            ...
            /// <summary>
            /// </summary>
            public int InitLockStatus;
        }

        /// <summary>
        /// Operation result and output arguments for RenewLock.
        /// </summary>
        public struct RenewLockAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
        ...
        /// <summary>
        /// Gets or sets the LockingServices async methods.
        /// </summary>
        /// <value>
        /// The LockingServices async methods.
        /// </value>
        public ILockingServicesAsyncMethods LockingServicesAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            ILockingServicesAsyncMethods implementation = LockingServicesAsyncMethods ?? this as ILockingServicesAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.DI.MethodIds.LockingServicesType_BreakLock)
            {
                var methodResult = await implementation.BreakLockAsync(context, this, context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.BreakLockStatus));
                }

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.LockingServicesType_ExitLock)
            {
                var methodResult = await implementation.ExitLockAsync(context, this, context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.ExitLockStatus));
                }

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.LockingServicesType_InitLock)
            {
                var methodResult = await implementation.InitLockAsync(context, this, (inputArguments[0].IsNull) ? null : inputArguments[0].ToString(), context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.InitLockStatus));
                }

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.LockingServicesType_RenewLock)
            {
                var methodResult = await implementation.RenewLockAsync(context, this, context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.RenewLockStatus));
                }
    ...
    /// <summary>
    /// The interface for async methods implemented on the LockingServicesModel object.
    /// </summary>
    public interface ILockingServicesAsyncMethods
    {
        /// <summary>
        /// https://reference.opcfoundation.org/DI/v104/docs/7.8
        /// </summary>
        ...
        /// <returns></returns>
        Task<LockingServicesModel.BreakLockAsyncResult> BreakLockAsync(
            RequestContext context,
            LockingServicesModel model,
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<LockingServicesModel.ExitLockAsyncResult> ExitLockAsync(
            RequestContext context,
            LockingServicesModel model,
            CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<LockingServicesModel.InitLockAsyncResult> InitLockAsync(
            RequestContext context,
            LockingServicesModel model,
            string Context,
            CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<LockingServicesModel.RenewLockAsyncResult> RenewLockAsync(
            RequestContext context,
            LockingServicesModel model,
            CancellationToken cancellationToken);
    ...
    public partial class FileSystemLoadingModel : SoftwareLoadingModel, IMethodDispatcher
    {
        ...
        #region Nested Structures
        /// <summary>
        /// Operation result and output arguments for GetUpdateBehavior.
        /// </summary>
        public struct GetUpdateBehaviorAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
        ...
        /// <summary>
        /// Operation result and output arguments for ValidateFiles.
        /// </summary>
        public struct ValidateFilesAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
            ...
            List<Variant> outputArguments)
        {
            ...
            if (methodDeclarationId == OpcUa.DI.MethodIds.FileSystemLoadingType_GetUpdateBehavior)
            {
                ...
                if (ret.IsGood())
                {
                    outputArguments[ 0 ] = new Variant((uint)UpdateBehavior);
                }
                return ret;
        ...
        /// <summary>
        /// Gets or sets the FileSystemLoading async methods.
        /// </summary>
        /// <value>
        /// The FileSystemLoading async methods.
        /// </value>
        public IFileSystemLoadingAsyncMethods FileSystemLoadingAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IFileSystemLoadingAsyncMethods implementation = FileSystemLoadingAsyncMethods ?? this as IFileSystemLoadingAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.DI.MethodIds.FileSystemLoadingType_GetUpdateBehavior)
            {
                var methodResult = await implementation.GetUpdateBehaviorAsync(context, this, inputArguments[0].ToNodeIdArray(), context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant((uint)methodResult.UpdateBehavior));
                }

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.FileSystemLoadingType_ValidateFiles)
            {
                var methodResult = await implementation.ValidateFilesAsync(context, this, inputArguments[0].ToNodeIdArray(), context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.ErrorCode));
                    outputArguments.Add(new Variant(methodResult.ErrorMessage));
                }
    ...
    /// <summary>
    /// The interface for async methods implemented on the FileSystemLoadingModel object.
    /// </summary>
    public interface IFileSystemLoadingAsyncMethods
    {
        /// <summary>
        /// https://reference.opcfoundation.org/DI/v104/docs/8.4.6/#8.4.6.3
        /// </summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<FileSystemLoadingModel.GetUpdateBehaviorAsyncResult> GetUpdateBehaviorAsync(
            RequestContext context,
            FileSystemLoadingModel model,
            NodeId[] NodeIds,
            CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<FileSystemLoadingModel.ValidateFilesAsyncResult> ValidateFilesAsync(
            RequestContext context,
            FileSystemLoadingModel model,
            NodeId[] NodeIds,
            CancellationToken cancellationToken);
    ...
    public partial class CachedLoadingModel : PackageLoadingModel, IMethodDispatcher
    {
        ...
        /// <summary>
        /// Gets or sets the CachedLoading async methods.
        /// </summary>
        /// <value>
        /// The CachedLoading async methods.
        /// </value>
        public ICachedLoadingAsyncMethods CachedLoadingAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            ICachedLoadingAsyncMethods implementation = CachedLoadingAsyncMethods ?? this as ICachedLoadingAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.DI.MethodIds.CachedLoadingType_GetUpdateBehavior)
            {
                var methodResult = await implementation.GetUpdateBehaviorAsync(context, this, (inputArguments[0].IsNull) ? null : inputArguments[0].ToString(), (inputArguments[1].IsNull) ? null : inputArguments[1].ToString(), inputArguments[2].ToStringArray(), context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant((uint)methodResult.UpdateBehavior));
    ...
    /// <summary>
    /// The interface for async methods implemented on the CachedLoadingModel object.
    /// </summary>
    public interface ICachedLoadingAsyncMethods
    {
        /// <summary>
        /// https://reference.opcfoundation.org/DI/v104/docs/8.4.5/#8.4.5.5
        /// </summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<CachedLoadingModel.GetUpdateBehaviorAsyncResult> GetUpdateBehaviorAsync(
            RequestContext context,
            CachedLoadingModel model,
            string ManufacturerUri,
            string SoftwareRevision,
    ...
    public partial class ConfirmationStateMachineModel : FiniteStateMachineModel, IMethodDispatcher, IActivatableModel
    {
        ...
        /// <summary>
        /// Gets or sets the ConfirmationStateMachine async methods.
        /// </summary>
        /// <value>
        /// The ConfirmationStateMachine async methods.
        /// </value>
        public IConfirmationStateMachineAsyncMethods ConfirmationStateMachineAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IConfirmationStateMachineAsyncMethods implementation = ConfirmationStateMachineAsyncMethods ?? this as IConfirmationStateMachineAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.DI.MethodIds.ConfirmationStateMachineType_Confirm)
            {
                ret = await implementation.ConfirmAsync(context, this, context.CancellationToken).ConfigureAwait(false);
    ...
    /// <summary>
    /// The interface for async methods implemented on the ConfirmationStateMachineModel object.
    /// </summary>
    public interface IConfirmationStateMachineAsyncMethods
    {
        /// <summary>
        /// </summary>
        /// <param name="context"></param>
    ...
    public partial class InstallationStateMachineModel : FiniteStateMachineModel, IMethodDispatcher, IActivatableModel
    {
        ...
        /// <summary>
        /// Gets or sets the InstallationStateMachine async methods.
        /// </summary>
        /// <value>
        /// The InstallationStateMachine async methods.
        /// </value>
        public IInstallationStateMachineAsyncMethods InstallationStateMachineAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IInstallationStateMachineAsyncMethods implementation = InstallationStateMachineAsyncMethods ?? this as IInstallationStateMachineAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.DI.MethodIds.InstallationStateMachineType_InstallFiles)
            {
                ret = await implementation.InstallFilesAsync(context, this, inputArguments[0].ToNodeIdArray(), context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.InstallationStateMachineType_InstallSoftwarePackage)
            {
                ret = await implementation.InstallSoftwarePackageAsync(context, this, (inputArguments[0].IsNull) ? null : inputArguments[0].ToString(), (inputArguments[1].IsNull) ? null : inputArguments[1].ToString(), inputArguments[2].ToStringArray(), inputArguments[3].ToByteString(), context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.InstallationStateMachineType_Resume)
            {
    ...
    /// <summary>
    /// The interface for async methods implemented on the InstallationStateMachineModel object.
    /// </summary>
    public interface IInstallationStateMachineAsyncMethods
    {
        /// <summary>
        /// https://reference.opcfoundation.org/DI/v104/docs/8.4.9/#8.4.9.5
        /// </summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<StatusCode> InstallFilesAsync(
            RequestContext context,
            InstallationStateMachineModel model,
            NodeId[] NodeIds,
            CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<StatusCode> InstallSoftwarePackageAsync(
            RequestContext context,
            InstallationStateMachineModel model,
            string ManufacturerUri,
            string SoftwareRevision,
    ...
    public partial class PrepareForUpdateStateMachineModel : FiniteStateMachineModel, IMethodDispatcher, IActivatableModel
    {
        ...
        /// <summary>
        /// Gets or sets the PrepareForUpdateStateMachine async methods.
        /// </summary>
        /// <value>
        /// The PrepareForUpdateStateMachine async methods.
        /// </value>
        public IPrepareForUpdateStateMachineAsyncMethods PrepareForUpdateStateMachineAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IPrepareForUpdateStateMachineAsyncMethods implementation = PrepareForUpdateStateMachineAsyncMethods ?? this as IPrepareForUpdateStateMachineAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.DI.MethodIds.PrepareForUpdateStateMachineType_Abort)
            {
                ret = await implementation.AbortAsync(context, this, context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.PrepareForUpdateStateMachineType_Prepare)
            {
                ret = await implementation.PrepareAsync(context, this, context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.PrepareForUpdateStateMachineType_Resume)
            {
                ret = await implementation.ResumeAsync(context, this, context.CancellationToken).ConfigureAwait(false);
    ...
    /// <summary>
    /// The interface for async methods implemented on the PrepareForUpdateStateMachineModel object.
    /// </summary>
    public interface IPrepareForUpdateStateMachineAsyncMethods
    {
        /// <summary>
        /// </summary>
        /// <param name="context"></param>
    ...
    public partial class TransferServicesModel : BaseObjectModel, IMethodDispatcher
    {
        ...
        #region Nested Structures
        /// <summary>
        /// Operation result and output arguments for FetchTransferResultData.
        /// </summary>
        public struct FetchTransferResultDataAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
            ...
            /// <summary>
            /// </summary>
            public ExtensionObject FetchResultData;
        }

        /// <summary>
        /// Operation result and output arguments for TransferFromDevice.
        /// </summary>
        public struct TransferFromDeviceAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
            ...
            /// <summary>
            /// </summary>
            public int InitTransferStatus;
        }

        /// <summary>
        /// Operation result and output arguments for TransferToDevice.
        /// </summary>
        public struct TransferToDeviceAsyncResult
        {
            /// <summary>
            /// The Method operation result.
            /// </summary>
        ...
        /// <summary>
        /// Gets or sets the TransferServices async methods.
        /// </summary>
        /// <value>
        /// The TransferServices async methods.
        /// </value>
        public ITransferServicesAsyncMethods TransferServicesAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            ITransferServicesAsyncMethods implementation = TransferServicesAsyncMethods ?? this as ITransferServicesAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.DI.MethodIds.TransferServicesType_FetchTransferResultData)
            {
                var methodResult = await implementation.FetchTransferResultDataAsync(context, this, inputArguments[0].ToInt32(), inputArguments[1].ToInt32(), inputArguments[2].ToInt32(), inputArguments[3].ToBoolean(), context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.FetchResultData));
                }

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.TransferServicesType_TransferFromDevice)
            {
                var methodResult = await implementation.TransferFromDeviceAsync(context, this, context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.TransferID));
                    outputArguments.Add(new Variant(methodResult.InitTransferStatus));
                }

            }
            else if (methodDeclarationId == OpcUa.DI.MethodIds.TransferServicesType_TransferToDevice)
            {
                var methodResult = await implementation.TransferToDeviceAsync(context, this, context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.TransferID));
    ...
    /// <summary>
    /// The interface for async methods implemented on the TransferServicesModel object.
    /// </summary>
    public interface ITransferServicesAsyncMethods
    {
        /// <summary>
        /// https://reference.opcfoundation.org/DI/v104/docs/6.4.6
        /// </summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<TransferServicesModel.FetchTransferResultDataAsyncResult> FetchTransferResultDataAsync(
            RequestContext context,
            TransferServicesModel model,
            int TransferID,
            int SequenceNumber,
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<TransferServicesModel.TransferFromDeviceAsyncResult> TransferFromDeviceAsync(
            RequestContext context,
            TransferServicesModel model,
            CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<TransferServicesModel.TransferToDeviceAsyncResult> TransferToDeviceAsync(
            RequestContext context,
            TransferServicesModel model,
            CancellationToken cancellationToken);

...
namespace OpcUa.IA
{
    ...
    public partial class IStatisticsModel : BaseInterfaceModel, IMethodDispatcher
    {
        ...
        /// <summary>
        /// Gets or sets the IStatistics async methods.
        /// </summary>
        /// <value>
        /// The IStatistics async methods.
        /// </value>
        public IIStatisticsAsyncMethods IStatisticsAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IIStatisticsAsyncMethods implementation = IStatisticsAsyncMethods ?? this as IIStatisticsAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.IA.MethodIds.IStatisticsType_ResetStatistics)
            {
                ret = await implementation.ResetStatisticsAsync(context, this, context.CancellationToken).ConfigureAwait(false);
    ...
    /// <summary>
    /// The interface for async methods implemented on the IStatisticsModel object.
    /// </summary>
    public interface IIStatisticsAsyncMethods
    {
        /// <summary>
        /// https://reference.opcfoundation.org/v105/IA/v102/docs/6.2.1/#6.2.1.2
        /// </summary>
        ...
        /// <returns></returns>
        Task<StatusCode> ResetStatisticsAsync(
            RequestContext context,
            IStatisticsModel model,

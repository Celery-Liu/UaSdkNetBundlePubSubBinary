...
namespace OpcUa.Glass
{
    ...
    public partial class SpacerModel : BaseMaterialModel
    {
        ...
        public SpacerModel(SpacerModel template, DummyArgument dummy = null) : base(template)
        {
            ...
            else
            {
                ...
                {
                    Filling = new Filling_BaseDataVariableModel(template.Filling);
                }
        ...
        /// </summary>
        public partial class Filling_BaseDataVariableModel : BaseDataVariableModel<string>
        {
            /// <remarks/>
        ...
        /// </summary>
        [UaInstanceDeclaration(NamespaceUri = Namespaces.Glass)]
        public Filling_BaseDataVariableModel Filling { get; set; }
    ...
    public partial class ProductionJobModel : BaseObjectModel, IMethodDispatcher
    {
        ...
        /// <summary>
        /// Gets or sets the ProductionJob async methods.
        /// </summary>
        /// <value>
        /// The ProductionJob async methods.
        /// </value>
        public IProductionJobAsyncMethods ProductionJobAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IProductionJobAsyncMethods implementation = ProductionJobAsyncMethods ?? this as IProductionJobAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.Glass.MethodIds.ProductionJobType_AbortJob)
            {
                ret = await implementation.AbortJobAsync(context, this, context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.Glass.MethodIds.ProductionJobType_QueueJob)
            {
                ret = await implementation.QueueJobAsync(context, this, context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.Glass.MethodIds.ProductionJobType_ReleaseJob)
            {
                ret = await implementation.ReleaseJobAsync(context, this, context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.Glass.MethodIds.ProductionJobType_SuspendJob)
            {
                ret = await implementation.SuspendJobAsync(context, this, context.CancellationToken).ConfigureAwait(false);
    ...
    /// <summary>
    /// The interface for async methods implemented on the ProductionJobModel object.
    /// </summary>
    public interface IProductionJobAsyncMethods
    {
        /// <summary>
        /// </summary>
        /// <param name="context"></param>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<StatusCode> ReleaseJobAsync(
            RequestContext context,
            ProductionJobModel model,
            CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<StatusCode> SuspendJobAsync(
            RequestContext context,
            ProductionJobModel model,
            CancellationToken cancellationToken);
    ...
    public partial class ProductionModel : BaseObjectModel, IMethodDispatcher
    {
        ...
        /// <summary>
        /// Operation result and output arguments for InsertJob.
        /// </summary>
        public struct InsertJobAsyncResult
        {
            /// <summary>
        ...
        /// <summary>
        /// Gets or sets the Production async methods.
        /// </summary>
        /// <value>
        /// The Production async methods.
        /// </value>
        public IProductionAsyncMethods ProductionAsyncMethods { get; set; }
        ...
        public async virtual Task<CallMethodResult> DispatchMethodAsync(
            ...
            IList<Variant> inputArguments)
        {
            IProductionAsyncMethods implementation = ProductionAsyncMethods ?? this as IProductionAsyncMethods;
            ...
            else if (methodDeclarationId == OpcUa.Glass.MethodIds.ProductionType_ChangePositionInList)
            {
                ret = await implementation.ChangePositionInListAsync(context, this, (inputArguments[0].IsNull) ? null : inputArguments[0].ToString(), (inputArguments[1].IsNull) ? null : inputArguments[1].ToString(), inputArguments[2].ToBoolean(), context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.Glass.MethodIds.ProductionType_DeleteJob)
            {
                ret = await implementation.DeleteJobAsync(context, this, (inputArguments[0].IsNull) ? null : inputArguments[0].ToString(), context.CancellationToken).ConfigureAwait(false);

            }
            else if (methodDeclarationId == OpcUa.Glass.MethodIds.ProductionType_InsertJob)
            {
                var methodResult = await implementation.InsertJobAsync(context, this, (inputArguments[0].IsNull) ? null : inputArguments[0].ToString(), (inputArguments[1].IsNull) ? null : inputArguments[1].ToString(), inputArguments[2].ToNodeIdArray(), inputArguments[3].ToNodeIdArray(), context.CancellationToken).ConfigureAwait(false);
                ret = methodResult.StatusCode;
                if (ret.IsGood())
                {
                    outputArguments.Add(new Variant(methodResult.JobNodeId));
                }
    ...
    /// <summary>
    /// The interface for async methods implemented on the ProductionModel object.
    /// </summary>
    public interface IProductionAsyncMethods
    {
        /// <summary>
        /// https://reference.opcfoundation.org/v104/Glass/Flat/v100/docs/7.2.1/#7.2.1.2
        /// </summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<StatusCode> ChangePositionInListAsync(
            RequestContext context,
            ProductionModel model,
            string Target,
            string Source,
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<StatusCode> DeleteJobAsync(
            RequestContext context,
            ProductionModel model,
            string Identifier,
            CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<ProductionModel.InsertJobAsyncResult> InsertJobAsync(
            RequestContext context,
            ProductionModel model,
            string Identifier,
            string Name,
    ...
    public partial class GlassEventModel : BaseEventModel
    {
        ...
        public override void UpdateEvent(GenericEvent e)
        {
            ...
            if (this.Identifier != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.Identifier, e.Manager.NamespaceUris);
            ...
            if (this.JobdIdentifier != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.JobdIdentifier, e.Manager.NamespaceUris);
            ...
            if (this.Location != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.Location, e.Manager.NamespaceUris);
            ...
            if (this.MaterialIdentifier != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.MaterialIdentifier, e.Manager.NamespaceUris);
    ...
    public partial class IntermediateStepEvent : GlassEventModel
    {
        ...
        public override void UpdateEvent(GenericEvent e)
        {
            ...
            if (this.ProcessStep != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.ProcessStep, e.Manager.NamespaceUris);
            ...
            if (this.Status != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.Status, e.Manager.NamespaceUris);
    ...
    public partial class InterruptedEventModel : GlassEventModel
    {
        ...
        public override void UpdateEvent(GenericEvent e)
        {
            ...
            if (this.ProcessName != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.ProcessName, e.Manager.NamespaceUris);
    ...
    public partial class JobMovedEventModel : GlassEventModel
    {
        ...
        public override void UpdateEvent(GenericEvent e)
        {
            ...
            if (this.NewPosition != null)
            {
                ...
                {
                    string name = AbsoluteName.ToString(AbsoluteNames.NewPosition, e.Manager.NamespaceUris);
